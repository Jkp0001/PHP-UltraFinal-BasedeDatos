...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (strlen($temp_nombrePRoducto) == 0) { // CONTROLO QUE EL STRING LENGTH no sea 0
            ...
            $regex = '/^[a-zA-Z0-9\s]{2,40}+$/'; // se permite letras, números y espacios en blanco
        ...
        if ($nombre_fichero) {
            ...
            echo $_FILES["imagen"]["size"]; //Valido las imágenes para que el formulario de creación de productos sólo acepte imágenes de tipo jpg, jpeg o png, y que no pesen más de 1MB. 
            if (($_FILES["imagen"]["type"] == 'image/jpg' || $_FILES["imagen"]["type"] == 'image/jpeg' || $_FILES["imagen"]["type"] == 'image/png') && ($_FILES["imagen"]["size"] <= 1048576)) {
