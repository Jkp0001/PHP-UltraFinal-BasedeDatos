...
<body style="background:#FAEBD7">
    ...
    <header>
        <img src="img/Amazon_logo.svg.webp" alt="logo." style="width : 225px; height : 50px; padding-top: 10px;">
        <nav>
            <ul>
                    ...
                    <tr>
                        ...
                        <td>
                            <form class="carrito" action="" method="post">
                                ...
                                <input class="btn btn-warning" type="submit" value="Añadir a la cesta" <?php if ($producto->cantidad <= 0) echo "disabled" ?>>
                                <select class="selection" style="width : 50px; height : 25px" name="valor">
