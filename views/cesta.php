...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        while ($fila = $resultado->fetch_assoc()) {
            ...
            $cantidadrestante = $fila["cantidad"];
            $productos = $fila["idProducto"];

            $cantidadresta = "UPDATE productos SET cantidad = (cantidad - '$cantidadrestante') WHERE idProducto = '$productos'";
            $conexion->query($cantidadresta);
        }
